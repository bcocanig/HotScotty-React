  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      <section id="home" className="relative w-full min-h-screen flex items-center justify-center">
        ...
        {/* Text container - limit width only for text, not background */}
        <div className="relative z-10 max-w-5xl px-4 sm:px-6 lg:px-8 text-center text-white">
          <h1 className="text-4xl md:text-6xl font-serif font-bold mb-4 md:mb-6 max-w-4xl mx-auto leading-tight animate-on-scroll opacity-0">
            Your Private Desert Escape in Scottsdale
          </h1>
          <p className="text-xl md:text-2xl mb-6 md:mb-8 max-w-5xl mx-auto animate-on-scroll opacity-0" style={{ animationDelay: "0.3s" }}>
          ...
          <button
            ...
            className="bg-teal-600 hover:bg-teal-700 text-black font-medium px-8 py-4 text-lg rounded-lg transition-all duration-300 transform hover:scale-105 animate-on-scroll opacity-0"
      ...
      <section id="contact" className="py-20 relative">
        <div
          className="absolute inset-0 bg-cover bg-center"
          style={{
            backgroundImage: "url('/assets/end.avif')",
          }}
        ></div>
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-12 max-w-3xl mx-auto animate-on-scroll opacity-0">
            ...
            <p className="text-white/80 text-lg">
              Booking directly can save you compared to third-party platforms.
            </p>
          </div>
        </div>
      </section>
